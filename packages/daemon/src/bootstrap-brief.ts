...
export const BOOTSTRAP_BRIEF = `이 레포는 아직 Colo Design 도구와 연결되어 있지 않습니다. 레포를 살펴보고 아래 넷을 작성해 연결을 준비해 주세요.

1. \`colo-design.json\` (레포 루트) — 아래 형식을 지켜 주세요:
