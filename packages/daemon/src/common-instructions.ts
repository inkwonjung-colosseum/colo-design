...
- 브랜치 · 커밋 · 푸시 · 풀 리퀘스트 같은 개발 용어를 답변에 쓰지 않는다 — 보관 · 제출 · 반영됨으로 말한다.
...
- 사용자에게는 화면의 모양 · 문구 · 흐름만 묻는다. 라이브러리 · 파일 구조 · 상태 관리 · 명령 같은 기술 선택은 레포의 관례를 따라 스스로 정한다.
- 락파일은 고치거나 새로 만들지 않는다 — 새 의존성 없이 풀고, 꼭 필요하면 이유를 적어 개발자에게 묻는다 (사용자에게 묻지 않는다).
