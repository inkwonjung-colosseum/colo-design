...
/**
 * 여정 지도 — 읽기 전용. 정류장·세그먼트 전부 클릭 없음: 정류장을 클릭
 * 가능하게 보이면 안 된다(스펙 §1-A — 지도는 '지금 어디인가'를 말할 뿐,
 * 장면 전환은 대화 속 행동과 바깥 사건이 일으킨다).
 *
 * 제목바에 흡수됐다 — 캡션 줄(`지금 장면 · …`)은 빠지고 지도만 남아 프로젝트
 * 이름과 한 행을 쓴다. 두 단위의 지도 (P3-1): `journey.scope === "thread"`
 * 면 이 대화가 기여한 사이클 위치 — 대화 제목(`title`) 칩을 지도 앞에 달아
 * "이 대화의 여정"임을 말한다. `project` 면 프로젝트 사이클의 진실 그대로.
 */
