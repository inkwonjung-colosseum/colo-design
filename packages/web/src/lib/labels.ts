...
/**
 * Korean object particle for a label whose ending we cannot control:
 * 받침 있는 글자 뒤엔 `을`, 없으면 `를`. Non-hangul falls to `를`.
 */
...
/**
 * The headline a Bash row leads with: a command that IS one of the
